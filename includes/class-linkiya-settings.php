<?php
/**
 * Linkiya Settings — free settings page (F1–F10).
 *
 * @package Linkiya
 */
...
class Linkiya_Settings {
	...
	public static function init(): void {
		...
		add_action( 'admin_post_linkiya_save_settings', array( __CLASS__, 'handle_save' ) );
		add_action( 'admin_post_linkiya_export_settings', array( __CLASS__, 'handle_export' ) );
		add_action( 'admin_post_linkiya_import_settings', array( __CLASS__, 'handle_import' ) );
	}
	...
	public static function register_menu(): void {
		add_menu_page(
			...
			// phpcs:ignore WordPress.PHP.DiscouragedPHPFunctions.obfuscation_base64_encode -- Encoding SVG icon as data URI for the admin menu; not obfuscating code.
	...
	/**
	 * Handle settings JSON export download.
	 *
	 * @return void
	 */
	...
	/**
	 * Handle settings JSON file import.
	 *
	 * @return void
	 */
